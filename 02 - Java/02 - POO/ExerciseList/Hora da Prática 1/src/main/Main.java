...
public class Main {
  public static void main(String[] args) {
    ...
    produtos.add(new Produto("Banana", 4.99, 12));
    produtos.add(new Produto("Maça", 7.99, 8));
    produtos.add(new Produto("Pêra", 11.20, 3));
    produtos.add(new Produto("Mamão", 5.50, 7));
    produtos.add(new Produto("Melancia", 11.20, 9));
