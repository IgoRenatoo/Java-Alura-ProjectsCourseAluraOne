/*
  - Crie um projeto Java no IntelliJ que deve conter uma classe chamada `Perfil`, com o méthodo main, que ao executar deverá
...
*/
public class Perfil {
  public static String message = "Olá mundo!";
